		...
		let Editor = (function (){
			...
			Editor.prototype ={
				...
				initialize: function (){
					...
					<input type="color" class="cti-color cte-color cte-float-left" />
					<button class="cti-import cte-icon cte-float-left"><i class="ri-folder-open-line"></i></button>
					<button class="cti-mockup cte-icon cte-float-left"><i class="ri-t-shirt-line"></i></button>
					<select class="cti-key cte-select cte-float-left"></select>
					<button class="cti-save cte-icon cte-float-right"><i class="ri-save-3-line"></i></button>
